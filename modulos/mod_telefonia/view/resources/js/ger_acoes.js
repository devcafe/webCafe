						...
						table_gerAcoes.append(""+
							"<tr>"+
								"<td class = 'show width50 pull-left'>"+
									"<button id = 'show_"+ data[1][i].idAcao +"' name = 'show' type='button' class='btn btn-default' data-toggle='modal' data-target='#show_acao'>"+
								...
								"<td class = 'width100'>"+
									"<button id = 'del_"+ data[1][i].idAcao +"' name = 'delete' type='button' class='btn btn-danger pull-left'>"+
									  "<span class='glyphicon glyphicon-trash'></span>"+
									"</button>"+
									"<button id = 'edit_"+ data[1][i].idAcao +"' name = 'edit' type='button' class='btn btn-warning pull-left' data-toggle='modal' data-target='#add_acao'>"+
